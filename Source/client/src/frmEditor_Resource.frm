...
Private Sub cmbType_Click()
   ...
   Exit Sub
errorhandler:
    HandleError "cmbType_Click", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Dim tmpIndex As Long
   ...
   Exit Sub
errorhandler:
    HandleError "cmdDelete_Click", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub cmdSave_Click()
   ...
   Exit Sub
errorhandler:
    HandleError "cmdSave_Click", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub Form_Load()
   ...
   Exit Sub
errorhandler:
    HandleError "Form_Load", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub cmdCancel_Click()
   ...
   Exit Sub
errorhandler:
    HandleError "cmdCancel_Click", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub lstIndex_Click()
   ...
   Exit Sub
errorhandler:
    HandleError "lstIndex_Click", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Dim sString As String
   On Error GoTo scrlAnimation_Change_Error
...
scrlAnimation_Change_Error:

    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure scrlAnimation_Change of Form frmEditor_Resource"
End Sub
...
Private Sub scrlExhaustedPic_Change()
   ...
   Exit Sub
errorhandler:
    HandleError "scrlExhaustedPic_Change", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub scrlHealth_Change()
   ...
   Exit Sub
errorhandler:
    HandleError "scrlHealth_Change", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub scrlNormalPic_Change()
   ...
   Exit Sub
errorhandler:
    HandleError "scrlNormalPic_Change", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub scrlRespawn_Change()
   ...
   Exit Sub
errorhandler:
    HandleError "scrlRespawn_Change", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub scrlReward_Change()
   ...
   Exit Sub
errorhandler:
    HandleError "scrlReward_Change", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub scrlTool_Change()
   ...
   Exit Sub
errorhandler:
    HandleError "scrlTool_Change", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub txtMessage_Change()
   ...
   Exit Sub
errorhandler:
    HandleError "txtMessage_Change", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub txtMessage2_Change()
   ...
   Exit Sub
errorhandler:
    HandleError "txtMessage2_Change", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Dim tmpIndex As Long
   ...
   Exit Sub
errorhandler:
    HandleError "txtName_Validate", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
...
Private Sub cmbSound_Click()
   ...
   Exit Sub
errorhandler:
    HandleError "cmbSound_Click", "frmEditor_Resource", Err.Number, Err.Description, Erl
    Err.Clear
